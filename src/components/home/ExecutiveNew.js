                ...
                <ul class="list-group list-group-flush ">
                    ...
                    <li class="list-group-item bg-transparent ">
                        <div className='executiveInfo d-flex flex-column'>
                            <ul className='executiveInfo-instrction text-white fw-bold '><img src={instructionIcon} width={15}></img> &nbsp;Instruction:
                            <li className='executiveInfo-instrctionSm fw-normal ps-1 pt-3'>Ensure clarity and specificity when framing your questions to receive swift and effective answers.</li>
                            {/* <li className='executiveInfo-instrctionSm fw-normal ps-1'>Please choose the 'POCA Scoring System' option in the chat window's toggle feature, Note that 'DLBE' is the default selection.</li> */}
                            </ul>
                       ...
                       <span className='executiveInfoThirdLine text-white'>For starters, you can ask me questions such as :</span>
                            ...
                            <ul className='executiveInfonumber rounded ps-4 mt-4 py-2 '>
                            {
                            ...
                            <div className='question-text text-white p-2  '>Who has the best POCA scores in FY25 in EMEA?</div>
                            <div className='question-text text-white p-2 '>Which partners in Japan had the largest YoY differences in POCA scores?</div>
                            <div className='question-text text-white p-2 '>Which capabilities are strongest and weakest in Asia in FY25?</div>
