    ...
    return (
        <div className='navHome-container'>
            <ul className='navHome-options bg-white  d-flex align-items-center justify-content-between ps-0'>
                ...
                <li className='navHome-option-nexus px-1'>
                    <img src={pocaAImg} className='nexusImg'></img>
                </li>
                <li className='navHome-optionIcons align-items-center gap-4'>
                ...
                <li className='navHome-optionUser d-flex align-items-center px-3'>
                    <img className='navHome-optionUser-img' src={userImg} alt='Image of Logged In user'></img>
